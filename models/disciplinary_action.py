...
class DisciplinaryActionscustom(models.Model):
    ...
    @api.onchange('x_studio_action_date','x_studio_disciplinary_end_date','x_studio_reporting_date')
    @api.constrains('x_studio_action_date','x_studio_disciplinary_end_date','x_studio_reporting_date')
    def _constrainsdate2(self):
           for record in self: 
            if record.x_studio_action_date :   
